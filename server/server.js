...
const {getAllPlayers, getPlayerById, getPlayersByClubId, getPlayerStatistics, addPlayer, getTopPlayers, getTopPlayersInClub, deletePlayer} = require("./service/playersService");
...
app.get("/api/players/club/:id/top", getTopPlayersInClub)
